...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let originalBooks = Array.from(bookContainer.children).map(bookDiv => ({
            ...
            status: bookDiv.querySelector('.books-status').textContent,
        ...
        function updateDisplay() {
            ...
            `;
                ...
                paginatedBooks.forEach(book => {
                    ...
                    bookDiv.innerHTML = `
                    <div class="books-id" style="display: none">${book.id}</div>

                    <div class="books-image-2">
                        <img src="${book.image}" class="image">
                    </div>
                    <div class="books-status" style="display: none">${book.status}</div>
                    <div class="books-category" style="display: none">${book.category}</div>
                    <div class="books-borrow-status" style="display: none">${book.borrowStatus}</div>
                    <div class="books-favorite" style="display: none">${book.favoriteStatus}</div>
                    <div class="books-ratings" style="display: none">${book.avgRating}</div>
                    <div class="books-user-ratings" style="display: none">${book.patronRating}</div>
