...
books.forEach(book => {
    book.addEventListener('click', () => {
        ...
        const clickedRow = book.closest('.row-books-container');
        clickedRow.parentNode.insertBefore(bookDetailsContainer, clickedRow.nextSibling);
        ...
        } else if (bookCategory.toLowerCase() === 'circulation'.toLowerCase() && bookBorrowStatus.toLowerCase() === 'acccepted') {
            if (borrowButton) {
                borrowButton.disabled = true;
