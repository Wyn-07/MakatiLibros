                                ...
                                <div class="row-books">
                                    <?php foreach ($bookDetails as $book): ?>
                                        <div class="container-books">
                                            ...
                                            <div class="books-favorite" style="display: ;"><?php echo htmlspecialchars($book['favorite_status']); ?></div>
                                            <div class="books-ratings" style="display: ;"><?php echo htmlspecialchars($book['avg_rating']); ?></div>
                                            <div class="books-user-ratings" style="display: ;"><?php echo htmlspecialchars($book['patron_rating']); ?></div>
                                            <div class="books-copyright" style="display: ;"><?php echo htmlspecialchars($book['copyright']); ?></div>
