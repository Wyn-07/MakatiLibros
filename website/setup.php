                                ...
                                <div class="container-input">
                                    ...
                                    <?php foreach ($category as $categories): ?>
                                        ...
                                        <div class="container-interest">
                                            <div class="container-interest-image" onclick="toggleCheckbox('<?php echo $categories; ?>')">
                                                <!-- <img src="path/to/category-images/<?php echo $categories; ?>.jpg" class="image"> -->
                                                <img src="../images/no-image.png" class="image-contain" id="image-<?php echo $categories; ?>">
                                            </div>
                                            <div>
                                                <input type="checkbox" id="<?php echo $categories; ?>" name="category[]" value="<?php echo $categories; ?>" style="display:none">
                                                <label for="<?php echo $categories; ?>"> <?php echo $categories; ?></label>
                                            </div>
                                        </div>
