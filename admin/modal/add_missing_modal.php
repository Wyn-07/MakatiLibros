<div id="addModal" class="modal">
    <div class="modal-content">
        ...
        <form action="functions/add_missing.php" method="POST" enctype="multipart/form-data" id="form">
            <div class="container-form">
                ...
                <div class="container-input-100">
                    ...
                    <input type="text" id="title" name="title" class="input-text" autocomplete="off" required>
                </div>
