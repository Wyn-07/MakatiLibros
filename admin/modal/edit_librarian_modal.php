<div id="editModal" class="modal">
    <div class="modal-content-big">
        ...
        <form action="functions/update_librarian.php" method="POST" enctype="multipart/form-data" id="form" onsubmit="return validateEditForm(['edit_image'], 'editContact')">
            ...
            <input type="hidden" id="oldFirstname" name="oldFirstname">
            <input type="hidden" id="oldMiddlename" name="oldMiddlename">
            <input type="hidden" id="oldLastname" name="oldLastname">
            <input type="hidden" id="oldSuffix" name="oldSuffix">
            <input type="hidden" id="oldBirthdate" name="oldBirthdate">
            <input type="hidden" id="oldAge" name="oldAge">
            <input type="hidden" id="oldGender" name="oldGender">
            <input type="hidden" id="oldContact" name="oldContact">
...
<script>
    function openEditModal(element) {
        ...
        document.getElementById('oldFirstname').value = firstname;
        document.getElementById('oldMiddlename').value = middlename;
        document.getElementById('oldLastname').value = lastname;
        document.getElementById('oldSuffix').value = suffix;
        document.getElementById('oldBirthdate').value = birthdate;
        document.getElementById('oldAge').value = age;
        document.getElementById('oldGender').value = gender;
        document.getElementById('oldContact').value = contact;
        document.getElementById('oldAddress').value = address;
