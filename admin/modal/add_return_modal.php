<div id="addModal" class="modal">
    <div class="modal-content">
        ...
        <form action="functions/update_borrow.php" method="POST" enctype="multipart/form-data">
            <div class="container-form">

                <div class="container-input">

                    <input type="hidden" name="book_id" class="input-text" id="book_id" autocomplete="off" required>
                    <input type="hidden" name="status" class="input-text" id="status" autocomplete="off" value="Returned" required>
                    ...
                    <div class="container-input-100">
                        ...
                        <input type="text" name="borrow_id" class="input-text" id="borrow_id" autocomplete="off" required>
                    </div>
                    ...
                    <div class="container-input-100">
                        ...
                        <input type="text" name="acc_num" class="input-text" id="acc_num" autocomplete="off" required disabled>
                    </div>
