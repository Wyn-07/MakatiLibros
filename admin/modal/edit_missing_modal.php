    ...
    <div class="modal-content">
        ...
        <form action="functions/update_missing.php" method="POST" enctype="multipart/form-data" id="form" onsubmit="return validateForm()">
            <div class="container-form">
                <input type="hidden" id="edit_missing_id" name="edit_missing_id" class="input-text" autocomplete="off" required>
...
<script>
    function openEditModal(bookId, accNum, classNum, title, author, authorId, category, categoryId, copyright) {
        ...
        document.getElementById('edit_missing_id').value = bookId;
