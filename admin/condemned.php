...
include 'functions/fetch_condemned.php';
$condemnedList = getCondemnedList($pdo);
...
<body>
    <div class="wrapper">
                    ...
                    <div class="row">
                        ...
                        <table id="table">
                            ...
                            <tbody>
                                ...
                                <?php } else { ?>
                                    <?php foreach ($condemnedList as $book) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    <div class="button-view" onclick="openViewModal(
                                                                '<?php echo addslashes($book['condemned_id']); ?>', 
        ...
        <?php include 'modal/add_condemned_modal.php'; ?>

        <?php include 'modal/view_condemned_modal.php'; ?>
