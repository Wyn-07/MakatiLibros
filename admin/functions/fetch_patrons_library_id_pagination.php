...
$validColumns = ['patrons_name', 'card_id', 'date_issued', 'valid_until'];
...
// Start SQL query to fetch from `patrons_library_id` with associated patron and guarantor details
$query = "
    SELECT 
        pl.card_id,
        pl.date_issued, 
