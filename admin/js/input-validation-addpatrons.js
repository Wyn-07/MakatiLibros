...
var middleNameInput = document.getElementById("addMiddlename");
var lastNameInput = document.getElementById("addLastname");
var suffixInput = document.getElementById("addSuffix");
...
var companyAddressInput = document.getElementById("addCompanyAddress");
...
function validateAddForm(fileInputs, contactInputId) {
    var resultErrorContainer = document.getElementById("container-error-addpatron");
    var message = document.getElementById("message-addpatron");
    message.innerHTML = "";
