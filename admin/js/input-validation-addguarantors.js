...
function validateAddForm(contactInputId) {
    var resultErrorContainer = document.getElementById("container-error-addguarantor");
    var message = document.getElementById("message-addguarantor");
    message.innerHTML = "";
