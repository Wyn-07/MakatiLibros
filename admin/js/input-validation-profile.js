...
var firstNameInput = document.getElementById("profile_firstname");
var middleNameInput = document.getElementById("profile_middlename");
var lastNameInput = document.getElementById("profile_lastname");
var suffixInput = document.getElementById("profile_suffix");
...
function calculateMaxBirthDate() {
    ...
    document.getElementById('profile_birthdate').setAttribute('max', maxDateString);
}


function calculateAge() {
    var birthdateInput = document.getElementById('profile_birthdate');
    var ageInput = document.getElementById('profile_age');
