...
document.getElementById('logs').addEventListener('click', function () {
    var dropdown = document.querySelector('.sidebar-dropdown-content.logs');
    var expandArrow = document.getElementById('sidebar-expand-arrow-logs');
    var collapseArrow = document.getElementById('sidebar-collapse-arrow-logs');
