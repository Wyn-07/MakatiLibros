...
let totalBooks = 0;
let sortBookColumn = 'category';
let sortBookOrder = 'asc';
let searchQuery = "";

function sortTable(columnIndex) {
    // Map column index to column name for sorting
    const columnNames = ['acc_number', 'class_number', 'title', 'editions', 'author_name', 'category_name', 'copyright', 'copies'];
                ...
                <td>
                    <div class="td-center">
                        <div class="button-edit" 
                            ...
                            data-editions="${encodeURIComponent(book.editions)}"
                            ...
                            data-copies="${encodeURIComponent(book.copies)}"
